...
const DOCS_URL = 'https://potatofield.cn/imagenotebook/docs';
        ...
        new Dialog({
          ...
          content: (
            <>
              您必须先阅读并同意我们的
              <Link
                href="https://potatofield.cn/imagenotebook/terms#eula"
                target="_blank"
                underline="none"
              >
                《使用协议》
              ...
              和
              <Link
                href="https://potatofield.cn/imagenotebook/terms#privacy"
                target="_blank"
                underline="none"
              >
                《隐私政策》
        ...
        <div className="tabs">
          ...
          <div className="app-icon" onClick={openDocs}>
            ...
            <div className="app-icon-button">
              ...
              <Typography variant="caption" className="app-icon-button-text">
                文档
              </Typography>
            </div>
          </div>
          ...
          >
            <FontAwesomeIcon icon={NoteIcon} className="tab-icon" />
            笔记
          </div>
